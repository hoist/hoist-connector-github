  ...
  _createClass(GitHubPoller, [{
    ...
    value: function setupHook() {
      ...
      return Promise.resolve().then(function () {
        ...
        var hookUri = 'https://' + _config2['default'].get('Hoist.domains.endpoint') + '/' + _this3._context.organisation.slug + '/' + _this3._context.application.slug + '/' + _this3.context.connectorKey + '-incoming';
        ...
        return _this3._content.subscription.set('setup', true);
      });
    }
  }]);
